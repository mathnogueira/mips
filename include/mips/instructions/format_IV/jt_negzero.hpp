 ...
 * \file jt_negzero.hpp
 *
 * Instrução que faz o desvio quando a flag neg da alu é igual a 1 ou flag zero é igual a 1.
 */
#pragma once
 ...
 * \author Felipe Dias
 */
class JtNegzeroInstruction : public InstructionIV {
...
public:
     ...
     */
    JtNegzeroInstruction(bit8_t opcode, struct ALUFlags &aluFlags, bit8_t offset) :
